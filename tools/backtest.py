...
def run_ea_parity_backtest(df: pd.DataFrame, sl_atr_mult: float = 1.5, tp_atr_mult: float = 2.5) -> dict:
    """
...
def main() -> int:
    ...
    if len(sys.argv) >= 2 and sys.argv[1] == "ea_parity":
        ...
        result = run_ea_parity_backtest(df, sl_atr_mult=args.sl_atr_mult, tp_atr_mult=args.tp_atr_mult)
