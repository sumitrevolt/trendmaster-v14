...
GOLD_SWING = {
    ...
    'news_events': [
        'NFP', 'CPI', 'FOMC', 'PPI', 'GDP', 'PCE',
        'RETAIL_SALES', 'UNEMPLOYMENT', 'FED_SPEECH',
        'ECB_RATE', 'BOE_RATE', 'GEOPOLITICAL',
    ],
...
MARKET_PARAMS = {
    # ── TEAM 1: METALS ───────────────────────────────────────────────────────
    'XAUUSD': {
        'sl_atr_mult': 5.0, 'tp_atr_mult': 10.0, 'min_rr': 2.0,
        'trail_activation_pips': 150, 'trail_distance_pips': 80,
        'max_spread_pips': 40, 'max_trades_per_day': 1,
        'strategy_mode': 'SWING',
    },
    'XAGUSD': {
        'sl_atr_mult': 3.0, 'tp_atr_mult': 6.0, 'min_rr': 2.0,
        'trail_activation_pips': 80, 'trail_distance_pips': 50,
        'max_spread_pips': 30, 'max_trades_per_day': 2,
        'strategy_mode': 'SCALP',
    },

    # ── TEAM 2: FOREX ─────────────────────────────────────────────────────────
    'GBPJPY': {   # STAR PERFORMER 97.7% accuracy
        'sl_atr_mult': 2.0, 'tp_atr_mult': 5.0, 'min_rr': 2.0,
        'trail_activation_pips': 25, 'trail_distance_pips': 18,
        'max_spread_pips': 25, 'max_trades_per_day': 3,
    },
    'USDCAD': {   # 87% accuracy — star secondary
        'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'min_rr': 2.0,
        'trail_activation_pips': 20, 'trail_distance_pips': 15,
        'max_spread_pips': 20, 'max_trades_per_day': 3,
    },
    'USDCHF': {
        'sl_atr_mult': 2.0, 'tp_atr_mult': 3.5, 'min_rr': 1.5,
        'trail_activation_pips': 25, 'trail_distance_pips': 18,
        'max_spread_pips': 20, 'max_trades_per_day': 2,
    },
    'EURUSD': {   # Most liquid, tight spreads
        'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'min_rr': 2.0,
        'trail_activation_pips': 20, 'trail_distance_pips': 15,
        'max_spread_pips': 15, 'max_trades_per_day': 3,
    },
    'GBPUSD': {   # High volatility, wider SL
        'sl_atr_mult': 2.5, 'tp_atr_mult': 5.0, 'min_rr': 2.0,
        'trail_activation_pips': 25, 'trail_distance_pips': 18,
        'max_spread_pips': 20, 'max_trades_per_day': 2,
    },
    'AUDUSD': {   # Commodity-linked, moderate volatility
        'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'min_rr': 1.8,
        'trail_activation_pips': 20, 'trail_distance_pips': 15,
        'max_spread_pips': 18, 'max_trades_per_day': 2,
    },
    ...
    'NZDUSD': {   # Commodity currency, moderate
        'sl_atr_mult': 2.0, 'tp_atr_mult': 3.5, 'min_rr': 1.8,
        'trail_activation_pips': 18, 'trail_distance_pips': 13,
        'max_spread_pips': 20, 'max_trades_per_day': 2,
    },
    'EURJPY': {   # Volatile cross, good moves
        'sl_atr_mult': 2.5, 'tp_atr_mult': 5.0, 'min_rr': 2.0,
        'trail_activation_pips': 25, 'trail_distance_pips': 18,
        'max_spread_pips': 25, 'max_trades_per_day': 2,
    },
    'EURGBP': {   # Range-bound, tight moves
        'sl_atr_mult': 2.0, 'tp_atr_mult': 3.5, 'min_rr': 1.5,
        'trail_activation_pips': 15, 'trail_distance_pips': 12,
        'max_spread_pips': 20, 'max_trades_per_day': 2,
    },
    'AUDJPY': {   # Risk-on cross, good Asian/London
        'sl_atr_mult': 2.0, 'tp_atr_mult': 4.0, 'min_rr': 2.0,
        'trail_activation_pips': 20, 'trail_distance_pips': 15,
        'max_spread_pips': 22, 'max_trades_per_day': 2,
    },
    ...
    'BTCUSD': {   # High volatility, 24/7 — wider SL needed
        'sl_atr_mult': 3.0, 'tp_atr_mult': 6.0, 'min_rr': 2.0,
        'trail_activation_pips': 300, 'trail_distance_pips': 200,
        'max_spread_pips': 100, 'max_trades_per_day': 2,
    },
    'ETHUSD': {   # Follows BTC, slightly less volatile
        'sl_atr_mult': 3.0, 'tp_atr_mult': 6.0, 'min_rr': 2.0,
        'trail_activation_pips': 200, 'trail_distance_pips': 150,
        'max_spread_pips': 80, 'max_trades_per_day': 2,
    },
    ...
    'XTIUSD': {   # WTI Crude (was 'USOIL') — news-driven, high volatility
        'sl_atr_mult': 3.0, 'tp_atr_mult': 6.0, 'min_rr': 2.0,
        'trail_activation_pips': 100, 'trail_distance_pips': 60,
        'max_spread_pips': 50, 'max_trades_per_day': 2,
        'strategy_mode': 'SWING',
    },
    ...
    'XNGUSD': {   # Natural Gas — high seasonal volatility
        'sl_atr_mult': 3.5, 'tp_atr_mult': 7.0, 'min_rr': 2.0,
        'trail_activation_pips': 80, 'trail_distance_pips': 50,
        'max_spread_pips': 60, 'max_trades_per_day': 1,
        'strategy_mode': 'SWING',
    },
}
